...
function App() {
  return (
    <div className="App">
      <div className="flex items-center justify-center flex-col p-4 sm:p-6 w-[80%] border-1 rounded-sm">
                                        ...
                                        <form className="text-poppins mt-4" onSubmit={handleSubmit}>
                                            <div className="grid md:grid-cols-2 md:gap-6">
                                                <div className="relative z-0 w-full mb-4 mt-6">
                                                    ...
                                                    />
                                                    <label className="peer-focus:font-medium absolute text-base xl:text-lg text-gray-500 duration-300 transform -translate-y-6 scale-[0.65] top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-[#7948F6] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-[0.65] peer-focus:-translate-y-6">First name</label>
                                                ...
                                                <div className="relative z-0 w-full mb-4 mt-6">
                                                    ...
                                                    />
                                                    <label className="peer-focus:font-medium absolute text-base xl:text-lg text-gray-500 duration-300 transform -translate-y-6 scale-[0.65] top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-[#7948F6] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-[0.65] peer-focus:-translate-y-6">Last name</label>
                                            ...
                                            <div className="relative z-0 w-full mb-4 mt-6">
                                                <input type="email" name="email" id="email" className="block pt-2.5 pb-1 px-0 w-full text-base xl:text-lg text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-[#7948F6] peer" placeholder=" " 
                                                    ...
                                                    value={values.email}
                                                />
                                                <label className="peer-focus:font-medium absolute text-base xl:text-lg text-gray-500 duration-300 transform -translate-y-6 scale-[0.65] top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-[#7948F6] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-[0.65] peer-focus:-translate-y-6">Email address</label>
                                            ...
                                            <div className="grid md:grid-cols-2 md:gap-6">
                                                <div className="relative z-0 w-full mb-4 mt-6">
                                                    <input type="tel" name="phone" id="phone" className="block pt-2.5 pb-1 px-0 w-full text-base xl:text-lg text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-[#7948F6] peer" placeholder=" " 
                                                        ...
                                                        value={values.phone}
                                                    />
                                                    <label className="peer-focus:font-medium absolute text-base xl:text-lg text-gray-500 duration-300 transform -translate-y-6 scale-[0.65] top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-[#7948F6] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-[0.65] peer-focus:-translate-y-6">Phone number</label>
                                                ...
                                                <div className="relative z-0 w-full mb-4 mt-6">
                                                    ...
                                                    />
                                                    <label className="peer-focus:font-medium absolute text-base xl:text-lg text-gray-500 duration-300 transform -translate-y-6 scale-[0.65] top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-[#7948F6] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-[0.65] peer-focus:-translate-y-6">Company Name</label>
                                            ...
                                            <div className="mb-4 xl:mb-0 mt-4 xl:mt-10 w-full flex items-center justify-between">
                                                <button buttonType="prev" >Previous</button>
                                                <button buttonType="button" disabled={isSubmitting}>Submit</button>
                                            </div>
                                        </form>
                                    )}
                                </Formik>
